...
<body>
										...
										<tbody>
											<c:forEach var="item" items="${listProject}" >
		                                       <tr>
		                                           ...
		                                           <td>${item.endDate}</td>
		                                           <td>
		                                               <a href="<c:url value='/project-update?id=${item.id}' />" class="btn btn-sm btn-primary">Sửa</a>
		                                               <a href="#" class="btn btn-sm btn-danger btn-xoa" id-project = "${item.id}">Xóa</a>
    ...
    <script type="text/javascript" src = "js/project-table.js"></script>
</body>
