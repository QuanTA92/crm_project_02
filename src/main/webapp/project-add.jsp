		...
		<nav class="navbar navbar-default navbar-static-top m-b-0">
			<div class="navbar-header">
				...
				<div class="top-left-part">
					<a class="logo" href="<c:url value="/homepage"></c:url>"> <b> <img
				...
				<div class="row">
					...
					<div class="col-md-8 col-xs-12">
						<div class="white-box">
							...
							<form action="<c:url value='project-add' />" method="post"
								...
								<div class="form-group">
									<div class="col-sm-12">
										...
										<a href="<c:url value="/project-table" />" class="btn btn-primary">Quay lại</a>
									</div>
								</div>
							</form>
							...
							<c:if test="${isSuccess}">
								<div class="alert alert-success">Thêm dự án mới thành công</div>
							</c:if>
