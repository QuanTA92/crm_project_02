		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse slimscrollsidebar">
				<ul class="nav" id="side-menu">
					...
					<li>
					<a href="<c:url value="/users" />" class="waves-effect"><i
					...
					<li>
					<a href="<c:url value="/project-table" />" class="waves-effect"><i
							class="fa fa-table fa-fw" aria-hidden="true"></i><span
							class="hide-menu">Dự án</span></a></li>
					<li>
					<a href="<c:url value="/job-table" />" class="waves-effect"><i
							class="fa fa-table fa-fw" aria-hidden="true"></i><span
			...
			<div class="container-fluid">
				<div class="row bg-title">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						<h4 class="page-title">Thêm mới trạng thái</h4>
					</div>
				</div>
				<!-- /.row -->
				<!-- .row -->
				<div class="row">
					...
					<div class="col-md-8 col-xs-12">
						<div class="white-box">
							...
							<form action="<c:url value='/status-add'/>" method="post"
								class="form-horizontal form-material">
								<div class="form-group">
									<label class="col-md-12">Trạng thái</label>
									<div class="col-md-12">
										<input type="text" name="name" placeholder="Tên trạng thái"
								...
								<div class="form-group">
									<div class="col-sm-12">
										...
										<a href="<c:url value="/homepage" />" class="btn btn-primary">Quay lại</a>
									</div>
								</div>
							</form>
							<c:if test="${isSuccess}">
