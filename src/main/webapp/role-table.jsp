...
<body>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    <li style="padding: 10px 0 0;"><a href="<c:url value='/homepage' />" class="waves-effect"><i
                                class="fa fa-clock-o fa-fw" aria-hidden="true"></i><span
                                class="hide-menu">Dashboard</span></a></li>

                    <li><a href="<c:url value='/users' />" class="waves-effect"><i
                                class="fa fa-user fa-fw" aria-hidden="true"></i><span class="hide-menu">Thành viên</span></a>
                    </li>
                    ...
                    <li><a href="<c:url value='/project-table' />" class="waves-effect"><i
                                class="fa fa-table fa-fw" aria-hidden="true"></i><span
                                class="hide-menu">Dự án</span></a></li>

                    <li><a href="<c:url value='/job-table' />" class="waves-effect"><i
                                class="fa fa-table fa-fw" aria-hidden="true"></i><span
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <div class="table-responsive" id="role-table">
                                        ...
                                        <c:forEach var="item" items="${listRoles}">
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<c:url value='/role-update?id=${item.id}' />" class="btn btn-sm btn-primary">Sửa</a>
                                                    <a href="#" class="btn btn-sm btn-danger btn-xoa"
                                                        id-role="${item.id}">Xóa</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <button id="back-button" class="btn btn-primary btn-block">Quay lại</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            if (userRole !== 'ADMIN') {
                // Người dùng không có quyền "ADMIN", hiển thị thông báo
                $("#access-denied-message").show();

                // Ẩn bảng danh sách quyền
                $("#role-table").hide();
