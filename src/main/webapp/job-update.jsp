        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
					<li style="padding: 10px 0 0;"><a href= "<c:url value="/homepage" />"
                        ...
                        <div class="white-box">
                            <form action="<c:url value='/job-update' />" method="post" class="form-horizontal form-material">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select name = "users" class="form-control form-control-line">
                             ...
                             <input type="hidden" name="id" value="${param.id}" />
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <a href="<c:url value="/job-table" />" class="btn btn-primary">Quay lại</a>
                                    </div>
                                </div>
                            </form>
							...
							<c:if test="${not empty invalidEndDate}">
								<div class="alert alert-danger">${invalidEndDate}</div>
							</c:if>
							<c:if test="${not empty invalidDate}">

								<div class="alert alert-danger">${invalidDate}</div>
							</c:if>
							<c:if test="${isSuccess}">
								<div class="alert alert-success">Update thành công</div>
							</c:if>
